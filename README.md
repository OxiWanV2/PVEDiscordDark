...
```
~# wget https://raw.githubusercontent.com/OxiWan/PVEDiscordDark/master/PVEDiscordDark.sh
~# bash PVEDiscordDark.sh install
```
Or this oneliner
```
bash <(curl -s https://raw.githubusercontent.com/OxiWan/PVEDiscordDark/master/PVEDiscordDark.sh ) install
```
...
<a href="https://github.com/OxiWan/pvediscorddark/graphs/contributors">
