...
```
~# wget https://raw.githubusercontent.com/OxiWanV2/PVEDiscordDark/master/PVEDiscordDark.sh
~# bash PVEDiscordDark.sh install
```
Or this oneliner
```
bash <(curl -s https://raw.githubusercontent.com/OxiWanV2/PVEDiscordDark/master/PVEDiscordDark.sh ) install
```
...
<a href="https://github.com/OxiWanV2/pvediscorddark/graphs/contributors">
